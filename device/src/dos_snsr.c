...
snsr_buf_t dos_snsr_buf[ DOS_SNSR_SNSR_COUNT ];
...
int dos_snsr_init( void )
{
    ...
    snsr_buf_t*       snsr_dist_buf = &dos_snsr_buf[ 0 ];
    ...
    if(    
        ...
        sim_snsr_dist_init( snsr_dist_cfg, snsr_dist_buf )  // init distance sensor sim driver
    ...
    )
    {
        ...
        if( snsr_init( dos_snsr_cfgs, start_task, stop_task, DOS_SNSR_SNSR_COUNT, dos_snsr_buf, DOS_SNSR_SNSR_COUNT * sizeof( snsr_buf_t ) ) )
        {
